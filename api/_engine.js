...
const EMPLOYEE_DIRECTORY = {
  "priya.shah@acme.com":     { employee_id: "E1001", name: "Priya Shah",     department: "Finance",    tier: "Standard",  active: true },
  "marcus.lee@acme.com":     { employee_id: "E1002", name: "Marcus Lee",     department: "Operations", tier: "Standard",  active: true },
  "dana.ortiz@acme.com":     { employee_id: "E1003", name: "Dana Ortiz",     department: "Risk",       tier: "Executive", active: true },
  "sam.wong@acme.com":       { employee_id: "E1004", name: "Sam Wong",       department: "HR",         tier: "Standard",  active: true },
  "jordan.miles@acme.com":   { employee_id: "E1005", name: "Jordan Miles",   department: "Operations", tier: "Standard",  active: false }, // left the company
};
...
async function runTriage(input, seenKeys) {
  ...
  // BLOCK 1 · Trigger
  step("New Ticket Submitted", "1 Trigger", "EVENT", "received", "Webhook fired by the ticket form");
  ...
  const finish = (outcome, extra = {}) => {
    ...
    return buildTraceRow({ ticket, outcome, path, actions, flags, startedAt, ...extra });
  };
  ...
  if (dup.seen) return buildTraceRow({ ticket, outcome: "Dropped (Duplicate)", path, actions, flags, startedAt, requester: who.record });
...
function buildTraceRow({ ticket, outcome, path, actions, flags, startedAt, requester, classification, tier, kb, queue, sentiment, escalation_reason }) {
...
module.exports = { runTriage, CATEGORIES, URGENCIES, EMPLOYEE_DIRECTORY, KB_ARTICLES };
